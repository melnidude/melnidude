...
public:
	void placeOrder(int assetId, Order &order, long orderId);
	...
	void reserveIds(int numIds);
	void reqAccountUpdates(bool subscribe);
	void reqTickData(void);
	void cancelTickData();
	void reqAllOpenOrders();
	void reqContractDetails(int reqId, const Contract &contract);

	bool orderFailed(int errorCode);
	void cancelDimension(OrderId orderId);
	void liquidateDimension(const Contract& contract, int assetId, int position);
